...
float Timer::DisplaceStart(float diff)	//CHANGE/FIX: Doesn't work (the higher the multiplier the longer the lifespan when using this, it should to the opposite, but how?)
{
	started_at += diff;
	return started_at;
}